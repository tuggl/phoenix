...
namespace ns0
{
	internal sealed class Class102 : Class99
	{
		...
		{
			base.method_2().method_1(null, Class8.smethod_1("guidebot_welcome1"), true);
			base.method_2().method_1(null, Class8.smethod_1("guidebot_welcome2"), false);
		}
		...
		{
			if (base.method_1().string_3.ToLower() == class16_0.method_2().string_0.ToLower())
			{
