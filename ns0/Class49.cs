...
namespace ns0
{
	internal sealed class Class49
	{
		...
		public Class40 method_0()
		{
			...
			{
				result = Phoenix.smethod_15().method_8().method_2(this.list_0[0]);
			}
			return result;
		}
		public void method_1(GClass5 gclass5_0)
		{
			...
			{
				gclass5_0.method_7(Phoenix.smethod_15().method_8().method_4(Convert.ToInt32(this.string_0.Split(new char[]
				{
					'_'
				})[1])).string_0);
			}
			...
			gclass5_0.method_7(this.method_0().char_0.ToString());
			gclass5_0.method_9(this.method_0().int_0);
			string text = "";
			...
			gclass5_0.method_7(text);
			gclass5_0.method_9(this.int_3);
			gclass5_0.method_9(-1);
			gclass5_0.method_9(this.int_5);
		}
	}
}
