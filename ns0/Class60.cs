...
namespace ns0
{
	internal sealed class Class60
	{
		...
		{
			GClass4.smethod_0("Loading Bot data..");
			this.list_0 = new List<Class34>();
			DataTable dataTable = class6_0.method_3("SELECT * FROM bots;");
			DataTable dataTable2 = class6_0.method_3("SELECT id, bot_id, keywords, response_text, mode, serve_id FROM bots_responses;");
			DataTable dataTable3 = class6_0.method_3("SELECT text, shout, bot_id FROM bots_speech;");
